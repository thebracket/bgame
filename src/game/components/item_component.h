...
struct item_component {
     item_component() {}
     item_component( const string &t, const char slot=0, bool tint=false, const unsigned char r=0, const unsigned char g=0,
       const unsigned char b=0) : item_type(t), clothing_slot(slot),is_tinted(tint),tint_red(r),tint_green(g),tint_blue(b) {}
