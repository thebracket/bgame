...
void loading_screen::init()
{
	...
	count = 0;
	sg.children.push_back(
			make_unique<engine::scene_background>("splashscreen"));
}
...
pair<return_mode, unique_ptr<base_mode> > loading_screen::tick(
		const double time_elapsed)
{
	if (count == 1)
	{
		...
		game_engine->load_image_resource("power_bar_red.png", "power_bar_red");
		game_engine->load_image_resource("power_bar_green.png",
				"power_bar_green");
		game_engine->load_image_resource("double-height.png",
				"spritesheet-big");
		game_engine->load_image_resource("cordex.png", "cordex");
		game_engine->load_font_resource("../assets/font/disco___.ttf",
				"disco36", 36);
		game_engine->load_font_resource("../assets/font/Roboto-Medium.ttf",
				"disco14", 14);
		game_engine->load_font_resource("../assets/font/Roboto-Medium.ttf",
				"disco12", 12);
		game_engine->load_font_resource("../assets/font/Roboto-Medium.ttf",
				"disco10", 10);
		game_engine->load_font_resource("../assets/font/DisplayFree.ttf",
				"lcd10", 10);
	}
