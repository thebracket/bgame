...
void settler_melee_attacks_system::configure() {
    system_name = "Settler Melee System";
    subscribe_mbox<settler_attack_message>();
}

void settler_melee_attacks_system::settler_melee_attacks() {
...
void settler_melee_attacks_system::update(const double ms) {
