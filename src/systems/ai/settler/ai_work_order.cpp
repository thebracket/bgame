...
void ai_work_order::configure() {
    // Register with the jobs board
    jobs_board::register_job_offer<ai_tag_work_order>(jobs_board::evaluate_work_orders);
}

void ai_work_order::update(const double duration_ms) {
