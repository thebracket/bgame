...
enum job_major_t { JOB_IDLE, JOB_CONST, JOB_REACTION, JOB_ROGUE_GOTO, JOB_EQUIP_MELEE,
		JOB_ROGUE_BASH, JOB_EQUIP_RANGED, JOB_EQUIP_AMMO, JOB_HUNT, JOB_BUTCHERING, JOB_ROGUE_SHOOT, JOB_EQUIP_ARMOR,
		JOB_DECONSTRUCT, JOB_DEMOLISH, JOB_TIDY, JOB_HARVEST, JOB_ARCHITECT, JOB_PULL_LEVER };
enum job_minor_t { 
	JM_NONE,
...
CEREAL_REGISTER_TYPE(rltk::impl::component_store_t<rltk::impl::component_t<settler_ai_t>>)