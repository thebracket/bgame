...
struct lightsource_t {
	lightsource_t() {}
	lightsource_t(const int r, const bengine::color_t col) : radius(r), color(col) {}
	lightsource_t(const int r, const bengine::color_t col, const bool alert) : radius(r), color(col), alert_status(alert) {}
