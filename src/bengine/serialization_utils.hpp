...
template<>
inline void serialize(std::ostream &lbfile, const bengine::color_t &col) {
	serialize<float>(lbfile, col.r);
	serialize<float>(lbfile, col.g);
	serialize<float>(lbfile, col.b);
}
...
template<>
inline void deserialize(std::istream &lbfile, bengine::color_t &target) {
...
struct gzip_file {
	...
	template<class T>
	inline void serialize(const bengine::color_t &col) {
		serialize<float>(col.r);
		serialize<float>(col.g);
		serialize<float>(col.b);
	}
	...
	template<typename T>
	inline void deserialize(bengine::color_t &target) {
