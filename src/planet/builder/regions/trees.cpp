...
inline void plant_tree_deciduous(const int x, const int y, const int z, random_number_generator &rng) {
...
inline void plant_tree_evergreen(const int x, const int y, const int z, random_number_generator &rng) {
	// Trees get their own entity
...
void build_trees(std::pair<biome_t, biome_type_t> &biome, random_number_generator &rng) {
