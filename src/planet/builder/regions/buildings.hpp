...
void add_building(std::string tag, const int x, const int y, const int z, const std::size_t civ_owner=0);
void add_construction(region_t &region, const int x, const int y, const int z, const std::string type, bool solid=false, std::size_t civ_owner=0);
