tile_content = {
	...
	scanner_console = { index = 4097, glyph = glyphs['ramp_left'], foreground = colors['cyan'], background = colors['black'] },
	defense_console = { index = 4098, glyph = glyphs['ramp_right'], foreground = colors['cyan'], background = colors['black'] },
	education_console = { index = 4099, glyph = glyphs['ramp_up'], foreground = colors['cyan'], background = colors['black'] },
	communications_console = { index = 4100, glyph = glyphs['ramp_down'], foreground = colors['cyan'], background = colors['black'] },
