tile_content = {
	...
	yellow_sand = { index = 5, glyph = glyphs['double_wave'], foreground = colors['yellow_sand'], background = colors['black'], name="Yellow Sand" },
	...
	yellow_sand_dirty = { index = 7, glyph = glyphs['three_bar'], foreground = colors['yellow_sand'], background = colors['black'], name="Dirty Yellow Sand" },
	yellow_sand_ripples = { index = 8, glyph = glyphs['tilde'], foreground = colors['yellow_sand'], background = colors['black'], name="Rippled Yellow Sand" },

	red_sand = { index = 9, glyph = glyphs['double_wave'], foreground = colors['red_sand'], background = colors['black'], name="Red Sand" },
	red_sand_cracked = { index = 10, glyph = glyphs['percent'], foreground = colors['red_sand'], background = colors['black'], name="Cracked Red Sand" },
	red_sand_dirty = { index = 11, glyph = glyphs['three_bar'], foreground = colors['red_sand'], background = colors['black'], name="Dirty Red Sand" },
	red_sand_ripples = { index = 12, glyph = glyphs['tilde'], foreground = colors['red_sand'], background = colors['black'], name="Rippled Red Sand" },

	white_sand = { index = 13, glyph = glyphs['double_wave'], foreground = colors['white_sand'], background = colors['black'], name="White Sand" },
	...
	white_sand_dirty = { index = 15, glyph = glyphs['three_bar'], foreground = colors['white_sand'], background = colors['black'], name="Dirty White Sand" },
	white_sand_ripples = { index = 16, glyph = glyphs['tilde'], foreground = colors['white_sand'], background = colors['black'], name="Rippled White Sand" },

	pebbles = { index = 17, glyph = glyphs['colon'], foreground = colors['grey'], background = colors['black'], name="Pebbles" },
	gravel = { index = 18, glyph = glyphs['semicolon'], foreground = colors['grey'], background = colors['black'], name="Gravel" },
	mud = { index = 19, glyph = glyphs['percent'], foreground = colors['earth_brown'], background = colors['black'], name="Mud" },

	lychen = { index = 1024, glyph = glyphs['percent'], foreground = colors['lychen'], background = colors['black'], name="Lychen" },
	moss = { index = 1025, glyph = glyphs['comma'], foreground = colors['moss'], background = colors['black'], name="Moss" },
	cactus = { index = 1026, glyph = glyphs['clubs'], foreground = colors['cactus'], background = colors['black'], name="Cactus" },
	grass = { index = 1027, glyph = glyphs['quote'], foreground = colors['grass_green'], background = colors['black'], name="Grass" },
	grass_sparse = { index = 1028, glyph = glyphs['apostrophe'], foreground = colors['grass_green'], background = colors['black'], name="Sparse Grass" },
	...
	shrub = { index = 1033, glyph = glyphs['comma'], foreground = colors['grass_green'], background = colors['black'], name="Shrub" },
	heather = { index = 1034, glyph = glyphs['clubs'], foreground = colors['heather'], background = colors['black'], name="Heather" },
	...
	ship_floor = { index = 4101, glyph = glyphs['period'], foreground = colors['grey'], background = colors['dark_grey'], name="Ship Floor" },
