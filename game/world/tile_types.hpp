...
inline std::string tile_type_to_string ( const unsigned char t ) {
  switch (t) {
    ...
    case tile_type::FLAT : return "Flat";
    case tile_type::RAMP : return "Upwards Ramp";
    case tile_type::BEACH : return "Beach";
    case tile_type::MAGMA : return "Magma!";
    case tile_type::EMPTY_SPACE : return "Empty space";
    case tile_type::PERMANENT_ICE : return "Permanent Ice";
  }
  return "Unknown";
}
...
inline std::string climate_type_to_string ( const unsigned char t ) {
  switch (t) {
    ...
    case tile_climate::VERY_HOT : return "Very Hot";
    case tile_climate::SUBTERRANEAN : return "Subterranean";
    case tile_climate::MOLTEN : return "Molten";
  }
  return "Unknown";
}
...
inline std::string ground_type_to_string ( const unsigned char t ) {
  switch (t) {
    case tile_ground::IGNEOUS : return "Igneous Rock";
    case tile_ground::SEDIMENTARY : return "Sedimentary Rock";
    case tile_ground::GRAVEL : return "Rough Gravel";
    case tile_ground::WHITE_SAND : return "White Sand";
    case tile_ground::YELLOW_SAND : return "Yellow Sand";
    case tile_ground::RED_SAND : return "Red Sand";
    case tile_ground::PERMAFROST_WHITE : return "Permafrost";
    case tile_ground::PERMAFROST_BLUE : return "Permafrost";
    case tile_ground::PERMAFROST_CRACKED : return "Cracked Permafrost";
    case tile_ground::PERMAFROST_DIRTY : return "Permafrost and soil";
    case tile_ground::YELLOW_SAND_RIPPLE : return "Yellow Sand";
    case tile_ground::RED_SAND_RIPPLE : return "Red Sand";
    case tile_ground::RED_SAND_ROUGH : return "Red Sand and Gravel";
    case tile_ground::MUD : return "Muddy Soil";
  }
  return "Unknown";
}
...
inline std::string covering_type_to_string ( const unsigned char t ) {
  switch (t) {
    case tile_covering::BARE : return "Bare Ground";
    case tile_covering::MOSS : return "Moss";
    case tile_covering::LYCHEN : return "Lychen";
    case tile_covering::HEATHER : return "Heather";
    case tile_covering::GRASS : return "Grass";
    case tile_covering::SHRUB : return "Shrub";
    case tile_covering::THISTLE : return "Thistle";
    case tile_covering::GORSE : return "Gorse";
    case tile_covering::REEDS : return "Reeds";
    case tile_covering::WILDFLOWER : return "Wild flowers";
    case tile_covering::CACTUS : return "Cactus";
    case tile_covering::PEBBLES : return "Pebbles";
    case tile_covering::GRASS_SPARSE : return "Sparse Grass";
  }
  return "Unknown";
}
...
inline std::string biome_type_to_string ( const unsigned char t ) {
  switch (t) {
    case biome_types::TUNDRA : return "Tundra";
    case biome_types::DESERT : return "Desert";
    case biome_types::JUNGLE : return "Jungle";
    case biome_types::BADLANDS : return "Badlands";
    case biome_types::SWAMP : return "Swamp";
    case biome_types::FLATLAND : return "Flatland/Plain";
    case biome_types::WOODS : return "Woods";
    case biome_types::FOREST : return "Forest";
    case biome_types::HILLS : return "Hills";
  }
  return "Unknown";
}
