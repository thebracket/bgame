...
using my_messages = message_list_t<command_message, power_consumed_message, chat_emote_message, mouse_motion_message, build_order_message>;
...
using my_components = component_list_t<calendar_component, debug_name_component, obstruction_component, 
  ...
  item_storage_component, item_carried_component, description_component, item_component>;
