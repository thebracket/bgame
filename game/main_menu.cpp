...
class main_menu_sg : public engine::base_node {
	...
	const std::string btn_playgame = game_engine->render_text_to_image( "disco36", "Play The Game", "btn_playgame", sdl_white );
	const std::string btn_worldgen = game_engine->render_text_to_image( "disco36", "Generate The World", "btn_worldgen", sdl_white );
	const std::string btn_quit = game_engine->render_text_to_image( "disco36", "Exit The Game", "btn_quit", sdl_white );
	
	const std::string btn_playgame_a = game_engine->render_text_to_image( "disco36", "Play The Game", "btn_playgame_a", sdl_yelllow );
	const std::string btn_worldgen_a = game_engine->render_text_to_image( "disco36", "Generate The World", "btn_worldgen_a", sdl_yelllow );
	const std::string btn_quit_a = game_engine->render_text_to_image( "disco36", "Exit The Game", "btn_quit_a", sdl_yelllow );
